use crate::{
    ...
    CycleNextInlineAssist, CyclePreviousInlineAssist, OpenInlineAssist,
    ToggleModelSelector, Chat,
...
use language_model::{
    ...
    LanguageModelTextStream, Role,LanguageModelRequestTool
};
...
use ui::{
    prelude::*, ButtonLike, text_for_action, CheckboxWithLabel, IconButtonShape, KeyBinding, Popover, Tooltip,
};
...
pub fn init(
    ...
    cx.observe_new_views(|workspace: &mut Workspace, cx| {
        workspace.register_action(InlineAssistant::open_inline_assist);
...
impl InlineAssistant {
    ...
    pub fn open_inline_assist(
        workspace: &mut Workspace,
        _action: &OpenInlineAssist,
        ...
        let is_authenticated =
            {
                ...
                // assistant_panel.update(cx, |assistant, cx| assistant.is_authenticated(cx))
                let todo = (); // TODO read this from somewhere, since we're not reading it from the panel anymore.
                true
            };
