...
impl Interactivity {
    ...
    ///
    /// See [`ModelContext::listener`](crate::ModelContext::listener) to get access to the view state from this callback.
    ...
    ///
    /// See [`ModelContext::listener`](crate::ModelContext::listener) to get access to a view's state from this callback.
