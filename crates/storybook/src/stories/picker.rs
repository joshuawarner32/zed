...
impl PickerDelegate for Delegate {
    ...
    fn set_selected_index(&mut self, ix: usize, cx: &mut gpui::ModelContext<Picker<Self>>) {
        self.selected_ix = ix;
        cx.notify();
    }

    fn confirm(&mut self, secondary: bool, _cx: &mut gpui::ModelContext<Picker<Self>>) {
    ...
    fn dismissed(&mut self, cx: &mut gpui::ModelContext<Picker<Self>>) {
        cx.quit();
    }
    ...
    fn update_matches(
        &mut self,
        query: String,
        cx: &mut gpui::ModelContext<Picker<Self>>,
    ) -> Task<()> {
