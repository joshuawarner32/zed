...
use gpui::{
    ...
    Font, HighlightStyle, Model, Pixels, Point, SharedString, Task, View, ModelContext, WeakView,
    WindowContext,
};
...
pub mod test {
    ...
    use gpui::{
        ...
        InteractiveElement, IntoElement, Model, Render, SharedString, Task, View, ModelContext,
